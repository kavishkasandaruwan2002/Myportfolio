...
const About = () => {
  ...
  return (
    <section id="about" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-violet-500/5 rounded-full blur-3xl -z-10 -mr-64 -mt-64"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-3xl -z-10 -ml-64 -mb-64"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border hover:bg-accent transition-colors group">
                <div className="p-3 bg-card rounded-xl shadow-sm group-hover:bg-card text-violet-600">
                  <User className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-foreground">Career Goal</h4>
                  <p className="text-sm text-muted-foreground font-medium">Lead Developer</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border hover:bg-accent transition-colors group">
                <div className="p-3 bg-card rounded-xl shadow-sm group-hover:bg-card text-violet-600">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground font-medium">Full Stack & DevOps</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="glass p-8 rounded-[2rem] border-border bg-card/60 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-6">
                  <div className="bg-secondary p-3 rounded-xl border border-border">
                    <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider mb-1">GPA</p>
                    <p className="text-lg font-black text-foreground">3.11</p>
                  </div>
                  <div className="bg-secondary p-3 rounded-xl border border-border">
                    <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider mb-1">Degree</p>
                    <p className="text-lg font-black text-foreground">BSc (Hons)</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-slate-900 border border-slate-800 p-8 rounded-[2rem] text-white shadow-2xl relative overflow-hidden">
