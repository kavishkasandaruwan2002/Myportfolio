      ...
      <div className="container-custom">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            ...
            <div className="absolute left-[31px] md:left-1/2 top-0 bottom-0 w-0.5 bg-border transform md:-translate-x-1/2"></div>
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <div className="absolute left-0 md:left-1/2 transform -translate-x-1/2 z-10">
                    <div className="w-16 h-16 bg-card rounded-2xl shadow-xl flex items-center justify-center border-4 border-background group">
                  ...
                  <div className={`ml-20 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'}`}>
                    <div className="bg-card p-8 rounded-[2.5rem] shadow-xl shadow-primary/5 border border-border hover:scale-[1.02] transition-transform duration-500">
                      <div className="mb-6">
                        <span className="inline-block px-3 py-1 bg-violet-500/10 text-violet-500 text-xs font-black uppercase tracking-widest rounded-lg mb-4">
                          {exp.type}
                        </span>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-8 text-sm font-bold text-muted-foreground">
