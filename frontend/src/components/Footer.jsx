		...
		<footer className="w-full border-t border-border bg-background py-12">
			<div className="container-custom grid grid-cols-1 gap-10 md:grid-cols-3 md:items-center">
				<div className="flex items-center gap-4">
					...
					<div>
						<div className="font-black text-foreground leading-none mb-1">Kavishka Sandaruwan</div>
				...
				<div className="flex flex-col items-start md:items-end gap-4">
					<div className="flex items-center gap-6">
						<a href="https://github.com/kavishkasandaruwan2002" aria-label="GitHub" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
						...
						<a href="https://twitter.com/" aria-label="Twitter" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
					...
					<div className="text-xs font-black text-muted-foreground/30 uppercase tracking-[0.2em]">
						© {year} <span className="text-muted-foreground/50">Archived Deployment</span>
					</div>
				</div>
			</div>
		</footer>
